...
export default class ScopingShim {
  ...
  _prepareHost(host) {
    ...
    const styleInfo = new StyleInfo(ast, placeholder, ownStylePropertyNames, is, typeExtension, cssBuild); // only set the style info after this element has registered its template
  ...
  flushCustomStyles() {
    ...
    this._customStyleInterface['enqueued'] = false; // if custom elements have upgraded and there are no native css variables, we must recalculate the whole tree
