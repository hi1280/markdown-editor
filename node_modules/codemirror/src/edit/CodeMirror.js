...
import { defaults, optionHandlers, Init } from "./options.js"; // A CodeMirror instance represents an editor. This is the object
...
export default CodeMirror; // Attach the necessary event handlers when initializing the editor
...
function registerEventHandlers(cm) {
  ...
  if (!captureRightClick) on(d.scroller, "contextmenu", e => onContextMenu(cm, e)); // Used to suppress mouse event handling when a touch happens
