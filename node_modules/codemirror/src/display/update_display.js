...
import { adjustView, countDirtyView, resetView } from "./view_tracking.js"; // DISPLAY DRAWING
  ...
  for (let first = true;; first = false) {
    if (!first || !cm.options.lineWrapping || update.oldDisplayWidth == displayWidth(cm)) {
      ...
      if (viewport && viewport.top != null) viewport = {
        top: Math.min(cm.doc.height + paddingVert(cm.display) - displayHeight(cm), viewport.top) // Updated line heights might result in the drawn area not
