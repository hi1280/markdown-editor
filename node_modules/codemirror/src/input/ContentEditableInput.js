...
import { Delayed, lst, sel_dontScroll } from "../util/misc.js"; // CONTENTEDITABLE INPUT STYLE
...
export default class ContentEditableInput {
  ...
  init(display) {
    ...
    on(div, "paste", e => {
      if (signalDOMEvent(cm, e) || handlePaste(e, cm)) return; // IE doesn't fire input events, so we schedule a read for the pasted content in this way
