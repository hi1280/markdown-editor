...
import { indentLine } from "./indent.js"; // This will be set to a {lineWise: bool, text: [string]} object, so
...
export function applyTextInput(cm, inserted, deleted, sel, origin) {
  ...
  let updateInput; // Normal behavior is to insert the new text into every selection
